...
## Лицензия 3DAI Studio

> **ADR-003: Коммерческое использование сгенерированного контента разрешено.**
> **Дата:** 2026-06-17.
> **Условия:** Платформа предоставляет неисключительное право использовать
> сгенерированные 3D-модели, включая коммерческое использование. Подходит
> для встраивания ассетов в продукт без выплаты роялти.
> **Следствия:**
> - Ассеты безопасно коммитить в репо и распространять в составе игры
> - Лицензия неисключительная — теоретически тот же контент могут
>   получить другие разработчики; для уникальности — итерации промпта
>   и Blender-чистка сделают модели визуально отличными
> - Перед глобальным релизом (Phase 4) — повторно сверить актуальную
>   версию ToS на момент публикации в Stores

## Открытые вопросы

- [ ] Watermark / водяные знаки в free-tier — нужен ли paid plan
- [ ] Auto-rig 3DAI достаточно хорош или всегда нужен Blender-пас?
- [ ] Уникализация моделей (для anti-asset-flip восприятия) — отдельный пас в Blender?
